...
> 本文件从原 `README.md` 中拆分而来，记录暑期阶段每日学习记录。
...
### Day3
- 更细粒度的阅读了一下源码, 因为大部分都被分离成了crate, 所以源码基本都是和启动相关的, 进行了更细粒度的整理, 在`axvisor_start.md`里
...
### Day19
总结了hvisor中, 虚拟化环境开启需要的前置条件, 在[hvisor_note](../../docs/notes/hvisor_note.md)中, 并对照架构手册进行相关寄存器查阅

### Day20
完成了两个实验, 了解了最简hypervisor, 以及如何进行二阶段地址映射, 初步写了文档, 没有整理完.

### Day21
查阅了axplat_crates中的boot代码了解了龙芯架构,非虚拟化的启动流程, 并整理了相关文档:[boot](../../docs/notes/boot.md)
...
### Day23
完成了两个实验的整理, 在[hypervisor.md](../../docs/notes/hvisor_note.md)里, 闪到腰了, 卧床休息几天

### Day24
完成了h系列所有实验, 并对4个实验笔记进行了整理[hypervisor](../../docs/notes/riscv_hypervisor.md);
...
### Day28
- 整理了两阶段地址翻译的信息(仍需完善)[spt.md](../../docs/notes/spt.md)
- 初步尝试适配`axaddrspace`
...
### Day31
- 完成了vcpu大部分框架的搭建, 利用拓展写出了一份todo列表
- 实现了架构无关的代码
